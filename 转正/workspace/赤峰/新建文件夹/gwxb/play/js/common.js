...
var Event = {
	mapping: function(__event){
		...
		iDebug("[common.js]---tmpAgent="+tmpAgent);
...
function getSmartCardId(){ 
	try{
		return typeof CAManager != "undefined" ? CAManager.cardSerialNumber : (typeof CA != "undefined" ? (CA.serialNumber || CA.card.serialNumber) : "8888888");
	} catch (e){ 
		return "";
	} 
}
...
/**************根据orders字段的值从小到大重新排列栏目:用于公司酒店系统 begin****************/
...
/**************根据orders字段的值从小到大重新排列栏目:用于公司酒店系统 end****************/

/**************将自定义json串转化为常规json串:用于公司酒店系统 begin****************/
...
/**************将自定义json串转化为常规json串:用于公司酒店系统 end****************/
function iDebug(str){
