...
var slaveAddr 	= 	["http://slave"+globalDomain+":13160","http://api.slave"+globalDomain+":13160"][Flag],//"http://192.168.36.105:13160"
	dtvsAddr	=	"http://dtv"+globalDomain,
	accountAddr =	"http://access"+globalDomain,
	webclient 	= 	"http://web.eis/homed/app/education",
	appAddr     =   "http://apps"+globalDomain,
	jiayuAddr  = "http://192.168.36.154/app/test/jiayu/pages/index.htm",
	...
	adImgClient =   "http://ads"+globalDomain+":8123", //图文广告的请求域名
	//welcomeiPanelAddr = "http://115.29.188.74:8383/wechat_msg/welcomeview.html",
	...
	subjectPageAdd = webclient + "/application/homedPortal/subject/subject.php", //专题页面地址
	musicHomePageAdd = "http://192.168.36.154/app/test/appTemp/application/index.htm", //音乐产品化通用版首页地址
