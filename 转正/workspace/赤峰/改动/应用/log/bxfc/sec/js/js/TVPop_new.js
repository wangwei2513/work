...
(function() {
    var container = function(args) {
        ...
        this.init = function() {
            ...
            iDebug("=-------70wangwei-----" + this.TVPopdata.data.stringify())
        ...
        this.showFocus = function(_pos) {
            ...
            iDebug(this.tdName + _pos + "==showFocus==tmpPos===" + tmpPos + "=this.dataArr.obj[tmpPos].isNewFlag==" + this.dataArr.obj[tmpPos].isNewFlag);
        ...
        this.goToBackTv = function() {
            ...
            if (this.isiPanel) {
                ...
                var __params = {
                    ...
                    // name:name,
                    // idxtype:idxtype,
                    videoId: this.TVPopdata.data[tmpNum].id,
                    // chanId:this.TVPopdata.channelId,
                    // programId:programId,
                    backUrl: encodeURIComponent(window.parent.location.href)
                }
                ...
                iDebug("-playAddress--wangwei---" + playAddress);
                iDebug("-playAddress--wangwei--tmpNum-" + tmpNum);
                iDebug("-videoId--wangwei-id--" + this.TVPopdata.data[tmpNum].id);
                iDebug("-videoId--wangwei-program_id--" + this.TVPopdata.data[tmpNum].program_id)

                // iDebug("-videoId--wangwei--stringfy---" + this.TVPopdata.stringify());
                iPanel.eventFrame.openPage(
                	playAddress,__params
                );
                // window.parent.location.href = "http://10.14.41.246/application/playCase/vodPlay.htm?videoId=" + this.TVPopdata.data[tmpNum].id + '&backUrl=' + encodeURIComponent(window.parent.location.href);
