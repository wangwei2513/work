...
var enableSpec = true;//是否允许菜单键进入portal首页，tv键进入直播等功能
var defaultNewDay=2;
var newStyle="imgt";
var MPlayer = ["http://10.0.10.35/application/dezou/newPlay/play.php","../../player/play.htm"];//播放页面地址，使用前请一定要配置好视频播放页面
var REG = /.*(.html|.htm|.php|.jsp|.asp)$/;//列出常用一些页面，用作判断是否是视频
/******************************** 消息的处理-start ***********************************************/
