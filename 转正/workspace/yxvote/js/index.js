...
var keycode = eventObj.code;
  ...
  switch(keycode){
    ...
    case "KEY_SELECT":
		if(navPos==0){
			window.location.href = "dsdc.htm";	
		}else{
			window.location.href = "myzj.htm";		
		}
        return EVENT.STOP;
        break;
    case "KEY_BACK":
        window.parent.location.href = "http://192.168.18.101/zhsq/yangquan/Portal/index.htm";//"../portalmain/index.htm";
        return EVENT.STOP;
        break;
  }
}
