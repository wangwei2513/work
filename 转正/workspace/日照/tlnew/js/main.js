...
function grabEvent(event) {
    ...
    switch (keycode) {
        ...
        case 340:
        case 8:
            if(mySessionStorage.getItem("welcomeUrl")){
                var backUrl = mySessionStorage.getItem("welcomeUrl");
                mySessionStorage.removeItem("welcomeUrl");
                window.location.href = backUrl;
            }
            else if(mySessionStorage.getItem("platformUrl")){
