...
var globalColorConf = {};
//颜色 深到浅
globalColorConf.tdBgColor1 = "#5e4783";		//输入法各色块颜色
globalColorConf.tdBgColor2 = "#483667";		//输入法各色块颜色
globalColorConf.tdBgColor3 = "#675388";		//输入法各色块颜色
globalColorConf.tdBgColor4 = "#7a669d";		//输入法各色块颜色
...
globalColorConf.changeInputColor = "#8067a8";//各种输入切换按钮的文字颜色
globalColorConf.cursorColor  ="#2f204a";//光标颜色
