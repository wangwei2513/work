...
function showList(__listSize, __dataSize, __position, __startplace, __f){
	...
	this.checkFocusPos = function(__num){
		if(this.showType==0){	
            ...
            console.log("15555"+(this.lastPosition+__num))
            console.log("15555"+(this.dataSize-1))
...
function showList1(__listSize, __dataSize, __position, __startplace, __f){
	...
	this.changeList = function(__num){
        ...
        console.log("156156"+this.dataSize/this.listSize)
        console.log("154515"+((this.position+1)/this.listSize))
        if (this.position + __num < this.dataSize && this.position + __num >= 0) {
            this.position = this.position + __num;// % this.dataSize;
        } else if (this.position + __num > this.dataSize - 1 && Math.ceil(this.dataSize/this.listSize) - Math.ceil((this.position+1)/this.listSize) > 0) {
            this.position = this.dataSize-1;
        }
        console.log("weizhi0"+(this.position))
		this.setFocus();
		this.checkPage();
	};
